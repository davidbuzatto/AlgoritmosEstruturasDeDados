...
/**
 * Teste de uso da estrutura union-find com união rápida ponderada pelo
 * ranque, com compressão de caminho (WeightedQuickUnionPathCompressionUF).
 *
 * @author Prof. Dr. David Buzatto
 */
public class TestWeightedQuickUnionPathCompressionUF {
