...
import aesd.ds.interfaces.IndexedPriorityQueue;
...
public class IndexedMinPriorityQueue<Key extends Comparable<Key>> implements IndexedPriorityQueue<Key> {
     ...
     * heap mínimo. É chamado por insert() (o elemento recém-inserido pode
     * ter prioridade menor que o pai) e por changeKey()/decreaseKey()
     * (quando a chave diminui, o elemento pode precisar subir).
     *
     ...
     * heap mínimo. É chamado por delete()/delete(index) (o elemento movido
     * para o topo pode precisar descer) e por changeKey()/increaseKey()
     * (quando a chave aumenta, o elemento pode precisar descer).
     *
