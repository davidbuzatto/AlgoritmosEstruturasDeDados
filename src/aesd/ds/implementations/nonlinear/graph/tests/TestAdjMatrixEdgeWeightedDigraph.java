...
/**
 * Teste de uso do digrafo ponderado com array de duas dimensões de
 * adjacências (AdjMatrixEdgeWeightedDigraph).
 *
 * @author Prof. Dr. David Buzatto
 */
public class TestAdjMatrixEdgeWeightedDigraph {

    public static void main( String[] args ) {

        AdjMatrixEdgeWeightedDigraph g = new AdjMatrixEdgeWeightedDigraph( 6 );
