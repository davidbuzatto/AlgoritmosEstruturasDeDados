...
import static aesd.algorithms.dp.FibonacciProblem.DPBottomUpFibonacciWithCache;
...
public class FibonacciProblemTest {
    ...
    public static void main( String[] args ) {
        ...
        for ( int k = 0; k < times; k++ ) {
            for ( int i = 0; i <= n; i++ ) {
                buwcF = DPBottomUpFibonacciWithCache( i );
            }
        }
        t = nanoSecsToMilliSecs( System.nanoTime() - t );
        System.out.printf( "Bottom-Up c/ cache: fib(%d) = %,d (%dms)\n", n, buwcF, t );
