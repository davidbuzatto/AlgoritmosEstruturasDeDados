...
import aesd.algorithms.graph.BipartiteDFS;
import aesd.ds.implementations.nonlinear.graph.Graph;

/**
 * Teste de uso da detecção de bipartição (BipartiteDFS) em um grafo não
 * direcionado.
 *
 * @author Prof. Dr. David Buzatto
 */
public class TestBipartiteDFS {
    ...
    public static void main( String[] args ) {
        ...
        BipartiteDFS b1 = new BipartiteDFS( bipartite );
        ...
        BipartiteDFS b2 = new BipartiteDFS( notBipartite );
