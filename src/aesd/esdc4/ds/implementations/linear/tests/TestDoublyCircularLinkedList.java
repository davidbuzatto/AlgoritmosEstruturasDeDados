...
import aesd.esdc4.ds.implementations.linear.CircularDoublyLinkedList;
import aesd.esdc4.ds.interfaces.List;

/**
 * Teste de uso da lista circular genérica com encadeamento duplo.
 * 
...
public class TestDoublyCircularLinkedList {
    ...
    public static void main( String[] args ) {
        ...
        List<Integer> lista = new CircularDoublyLinkedList<>();
        ...
        System.out.println( "Verificando a circularidade:" );
