...
/**
 * Cópia a classe DirectedDijkstraSP com várias escritas no console para traçagem.
 * 
 ...
 */
public class DirectedDijkstraSPTrace {
     ...
     */
    public DirectedDijkstraSPTrace( EdgeWeightedDigraph digraph, int source ) throws IllegalArgumentException {
