...
/**
 * The {@code TernarySearchTree} class represents a symbol table of key-value pairs, with
 * string keys and generic values. It supports the usual <em>put</em>,
 * <em>get</em>, <em>contains</em>,
 * <em>delete</em>, <em>size</em>, and <em>is-empty</em> methods. It also
 * provides character-based methods for finding the string in the symbol table
 * that is the <em>longest prefix</em> of a given prefix, finding all strings in
 * the symbol table that <em>start with</em> a given prefix, and finding all
 * strings in the symbol table that <em>match</em> a given pattern. A symbol
...
public class TernarySearchTree<Value> {
    ...
    private int n;              // size
    private Node<Value> root;   // root of TernarySearchTree
